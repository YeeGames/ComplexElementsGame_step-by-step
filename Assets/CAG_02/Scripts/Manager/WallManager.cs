...
namespace CAG_02
{
    public class WallManager : MonoBehaviour
    {
        ...
        {
            /// 载入资源
            gset = Resources.Load<GameSettings>("CAG_02/Settings/Game Settings");
            lineRenderer = GetComponent<LineRenderer>();
            Material wallMaterial = Resources.Load<Material>("CAG_02/Materials/Wall Material");
        ...
        void BuildBoundingWall()
        {
            ...
            boundingWallWidth = gset.stageRadius * 2;
            boundingWallRadius = gset.stageRadius + boundingWallWidth / 2;
            positionCount = 360;
