...
namespace CEG_03
{
    ...
    public class YeeAgent : MonoBehaviour
    {
        ...
        {
            /// 载入资源
            this.aset = Resources.Load<AgentSettings>("CEG_03/Settings/Agent Settings");
            this.gset = Resources.Load<GameSettings>("CEG_03/Settings/Game Settings");
            // this.rset = Resources.Load<RuleSettings>("CEG_03/Settings/Rule Settings");
            Sprite agentMaterial = Resources.Load<Sprite>("CEG_03/Materials/Agent Material");
            // Sprite agentRuleEffectorAreaMaterial = Resources.Load<Sprite>("CEG_03/Materials/Rule Effector Material");
            PhysicsMaterial2D agentPhysicsMaterial = Resources.Load<PhysicsMaterial2D>("CEG_03/Materials/Agent Physics Material 2D");
