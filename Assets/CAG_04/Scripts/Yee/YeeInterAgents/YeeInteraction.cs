...
namespace CEG_04
{
    ...
    public class YeeInteraction : MonoBehaviour
    {
        ...
        [SerializeField] public Yee2ERule yee2ERule;
        ...
        internal void AddYeeInterAgent(YeeAgent thisYeeAgent, YeeAgent thatYeeAgent)
        {
            ...
            /// 计算Yee交互规则
            this._yeeInterAgent.yeeInterType = this.yee2ERule.CalcInterType(thisYeeAgent.yeeType, thatYeeAgent.yeeType);
        ...
        internal void UpdateYeeInteractionStatus(Vector2 thisPos, Vector2 thatPos)
        {
            for (int i = 0; i < this.YeeInterAgents.Count; i++)
            {
                ...
                _yeeInterAgent.yeeRuleForce = this.yee2ERule.CalcRuleForce(_yeeInterAgent.yeeInterType, thisPos, thatPos);
