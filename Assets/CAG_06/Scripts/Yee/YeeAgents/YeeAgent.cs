...
namespace CAG_06
{
    ...
    public class YeeAgent : MonoBehaviour
    {
        ...
        {
            /// 载入资源
            this.aset = Resources.Load<AgentSettings>("CAG_06/Settings/Agent Settings");
            this.gset = Resources.Load<GameSettings>("CAG_06/Settings/Game Settings");
            this.rset = Resources.Load<RuleSettings>("CAG_06/Settings/Rule Settings");
            Sprite agentMaterial = Resources.Load<Sprite>("CAG_06/Materials/Agent Material");
            Sprite agentRuleEffectorAreaMaterial = Resources.Load<Sprite>("CAG_06/Materials/Rule Effector Material");
            PhysicsMaterial2D agentPhysicsMaterial = Resources.Load<PhysicsMaterial2D>("CAG_06/Materials/Agent Physics Material 2D");
