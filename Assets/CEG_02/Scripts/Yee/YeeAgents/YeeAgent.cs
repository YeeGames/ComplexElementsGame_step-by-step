...
namespace CEG_02
{
    ...
    public class YeeAgent : MonoBehaviour
    {
        ...
        {
            /// 载入资源
            this.aset = Resources.Load<AgentSettings>("CEG_02/Settings/Agent Settings");
            this.gset = Resources.Load<GameSettings>("CEG_02/Settings/Game Settings");
            // this.rset = Resources.Load<RuleSettings>("CEG_02/Settings/Rule Settings");
            Sprite agentMaterial = Resources.Load<Sprite>("CEG_02/Materials/Agent Material");
            // Sprite agentRuleEffectorAreaMaterial = Resources.Load<Sprite>("CEG_02/Materials/Rule Effector Material");
            PhysicsMaterial2D agentPhysicsMaterial = Resources.Load<PhysicsMaterial2D>("CEG_02/Materials/Agent Physics Material 2D");
