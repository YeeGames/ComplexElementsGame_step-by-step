    ...
    public class YeeAgent : MonoBehaviour
    {
        ...
        private Vector2 Velocity
        {
            ...
            set
            {
                if (spriteRenderer != null)
                {
                    agentRigidbody2D.linearVelocity = value;
                }
            }
        }
        ...
        internal void SetAgentSettings(AgentSettings agentSettings)
        {
            ...
            this.agentRigidbody2D.linearDamping = agentSettings.linearDrag;
            this.agentRigidbody2D.angularDamping = agentSettings.angularDrag;
        ...
        {
            /// 载入资源
            this.aset = Resources.Load<AgentSettings>("CEG_04/Settings/Agent Settings");
            this.gset = Resources.Load<GameSettings>("CEG_04/Settings/Game Settings");
            this.rset = Resources.Load<RuleSettings>("CEG_04/Settings/Rule Settings"); //NOTE 新增
            Sprite agentMaterial = Resources.Load<Sprite>("CEG_04/Materials/Agent Material");
            Sprite agentRuleEffectorAreaMaterial = Resources.Load<Sprite>("CEG_04/Materials/Rule Effector Material"); //NOTE 新增
            PhysicsMaterial2D agentPhysicsMaterial = Resources.Load<PhysicsMaterial2D>("CEG_04/Materials/Agent Physics Material 2D");
        ...
        private void FixedUpdate()
        {
            ...
            this.agentRigidbody2D.linearVelocity = Vector2.ClampMagnitude(agentRigidbody2D.linearVelocity, maxSpeed); /// 限制最大速度；
