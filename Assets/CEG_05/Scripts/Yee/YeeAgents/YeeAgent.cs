...
namespace CEG_05
{
    ...
    public class YeeAgent : MonoBehaviour
    {
        ...
        {
            /// 载入资源
            this.aset = Resources.Load<AgentSettings>("CEG_05/Settings/Agent Settings");
            this.gset = Resources.Load<GameSettings>("CEG_05/Settings/Game Settings");
            this.rset = Resources.Load<RuleSettings>("CEG_05/Settings/Rule Settings");
            Sprite agentMaterial = Resources.Load<Sprite>("CEG_05/Materials/Agent Material");
            Sprite agentRuleEffectorAreaMaterial = Resources.Load<Sprite>("CEG_05/Materials/Rule Effector Material");
            PhysicsMaterial2D agentPhysicsMaterial = Resources.Load<PhysicsMaterial2D>("CEG_05/Materials/Agent Physics Material 2D");
